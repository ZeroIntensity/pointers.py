...
# autogenerated
__all__ = ("PyAIter","PyArg","PyBool","PyBuffer","PyByteArray","PyBytes","PyCallIter","PyCallable","PyCapsule","PyCodec","PyComplex","PyDescr","PyDictProxy","PyDict","PyErr","PyEval","PyException","PyFile","PyFloat","PyFrame","PyFrozenSet","PyGC","PyGILState","PyImport","PyIndex","PyInterpreterState","PyIter","PyList","PyLong","PyMapping","PyMem","PyMemoryView","PyModuleDef","PyModule","PyNumber","PyOS","PyObject","PySeqIter","PySequence","PySet","PySlice","PyState","PyStructSequence","PySys","PyThreadState","PyThread","PyTuple","PyType","PyUnicodeDecodeError","PyUnicodeEncodeError","PyUnicodeTranslateError","PyUnicode","PyWeakref","Py",)
...
class PyModule(_CallBase):
    ...
    def add_functions(module: PyObjectLike) -> int:
        return api_binding_base(API_FUNCS["PyModule_AddFunctions"], _deref_maybe(module))
