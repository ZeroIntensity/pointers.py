...
def api_binding_base(data: Func, *args):
    ...
    if not func:
        raise NotImplementedError(
            f"{data[2]} only supported on versions {data[1]}+",
        )
...
class PyCapsule(_CallBase):
    ...
    # PyCapsule_New
    @staticmethod
    def new(pointer: PointerLike, name: StringLike) -> PyObjectLike:
        return api_binding_base(API_FUNCS["PyCapsule_New"], pointer, make_string(name))
    ...
    @staticmethod
    def set_destructor(capsule: PyObjectLike) -> int:
        return api_binding_base(
            API_FUNCS["PyCapsule_SetDestructor"], _deref_maybe(capsule)
        )
...
class PyDescr(_CallBase):
    ...
    @staticmethod
    def new_class_method(type: PointerLike) -> PyObjectLike:
        return api_binding_base(API_FUNCS["PyDescr_NewClassMethod"], type)

    # PyDescr_NewGetSet
    @staticmethod
    def new_get_set(type: PointerLike) -> PyObjectLike:
        return api_binding_base(API_FUNCS["PyDescr_NewGetSet"], type)

    # PyDescr_NewMember
    @staticmethod
    def new_member(type: PointerLike) -> PyObjectLike:
        return api_binding_base(API_FUNCS["PyDescr_NewMember"], type)

    # PyDescr_NewMethod
    @staticmethod
    def new_method(type: PointerLike) -> PyObjectLike:
...
class PyEval(_CallBase):
    ...
    @staticmethod
    def acquire_thread(tstate: PointerLike) -> None:
    ...
    # PyEval_EvalFrame
    @staticmethod
    def eval_frame(f: PointerLike) -> PyObjectLike:
        return api_binding_base(API_FUNCS["PyEval_EvalFrame"], f)

    # PyEval_EvalFrameEx
    @staticmethod
    def eval_frame_ex(f: PointerLike, throwflag: int) -> PyObjectLike:
    ...
    @staticmethod
    def release_thread(tstate: PointerLike) -> None:
        return api_binding_base(API_FUNCS["PyEval_ReleaseThread"], tstate)

    # PyEval_RestoreThread
    @staticmethod
    def restore_thread(tstate: PointerLike) -> None:
...
class PyFrame(_CallBase):
    ...
    @staticmethod
    def get_line_number(frame: PointerLike) -> int:
...
class PyModule(_CallBase):
    ...
    # PyModule_AddType
    @staticmethod
    def add_type(module: PyObjectLike, type: PointerLike) -> int:
        return api_binding_base(
    ...
    # PyModule_Create2
    @staticmethod
    def create2(df: int) -> PyObjectLike:
        return api_binding_base(API_FUNCS["PyModule_Create2"], df)

    # PyModule_ExecDef
    @staticmethod
    def exec_def(module: PyObjectLike) -> int:
        return api_binding_base(API_FUNCS["PyModule_ExecDef"], _deref_maybe(module))

    # PyModule_FromDefAndSpec2
    @staticmethod
    def from_def_and_spec2(df: PyObjectLike, spec: int) -> PyObjectLike:
        return api_binding_base(
            API_FUNCS["PyModule_FromDefAndSpec2"], _deref_maybe(df), spec
        )
...
class PyObject(_CallBase):
    ...
    # PyObject_Init
    @staticmethod
    def init(op: PyObjectLike, type: PointerLike) -> PyObjectLike:
        return api_binding_base(API_FUNCS["PyObject_Init"], _deref_maybe(op), type)

    # PyObject_InitVar
    @staticmethod
    def init_var(op: PointerLike, type: PointerLike, size: int) -> PointerLike:
...
class PyState(_CallBase):
    ...
    # PyState_AddModule
    @staticmethod
    def add_module(module: PyObjectLike) -> int:
        return api_binding_base(API_FUNCS["PyState_AddModule"], _deref_maybe(module))
...
class PyStructSequence(_CallBase):
    ...
    @staticmethod
    def new(type: PointerLike) -> PyObjectLike:
...
class PyThreadState(_CallBase):
    ...
    # PyThreadState_Swap
    @staticmethod
    def swap(tstate: PointerLike) -> PointerLike:
...
class PyType(_CallBase):
    ...
    # PyType_GenericAlloc
    @staticmethod
    def generic_alloc(type: PointerLike, nitems: int) -> PyObjectLike:
        return api_binding_base(API_FUNCS["PyType_GenericAlloc"], type, nitems)

    # PyType_GenericNew
    @staticmethod
    def generic_new(
        type: PointerLike, args: PyObjectLike, kwds: PyObjectLike
    ) -> PyObjectLike:
        return api_binding_base(
...
class Py(_CallBase):
    ...
    # Py_EndInterpreter
    @staticmethod
    def end_interpreter(tstate: PointerLike) -> None:
